...
export default {
    ...
    data() {
        return {
            ...
            otherDataAPI: 'https://sheets.googleapis.com/v4/spreadsheets/14fPgycN0WGXYfCk_7kAA3MSFVyBUtdtmdUg9dY5N_g4/values/1?alt=json&key=AIzaSyCv9aoSSPDOFiXNuTMamA3lz0U19bYqYH0',
            data: [],
            results: [],
            serialKey: 0,
            alert: false,
